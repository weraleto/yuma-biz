      ...
      <!-- что такое микромаркеты -->
        <section class="micromarket">
          ...
          <div class="micromarket__cards">
            <div class="micromarket__cards--item card">
              <div class="micromarket__cards--item__inner">
                  <div class="micromarket__cards--item__front">
                      <h4 class="title2">торговое оборудование</h4>
                  </div>
                  <div class="micromarket__cards--item__back card-item__back">
                      <p class="text5">Холодильник, витрина и другие варианты на ваш выбор. Мы можем предложить наши модели, или установить все необходимое на ваше торговое оборудование.</p>
                  </div>
              </div>
            </div>
            <div class="micromarket__cards--item card">
            ...
            <div class="micromarket__cards--item card">
              <div class="micromarket__cards--item__inner">
                  <div class="micromarket__cards--item__front">
                      <h4 class="title2">программная платформа</h4>
                  </div>
                  <div class="micromarket__cards--item__back card-item__back">
                      <p class="text5">Программная платформа — это мобильное приложение для покупателей и полноценная система учёта, которыми удобно управлять в едином личном кабинете.</p>
                  </div>
              </div>
            </div>
          </div>
